...
proc genCSV {} {
    if {![file exists "game.csv"]} {
        ...
        puts $csvGames "14,Scythe,1,doom,1,freedoom2.wad,maps/scythe.zip"
        puts $csvGames "15,Scythe 2,1,doom,1,freedoom2.wad,maps/scythe2.zip"
        puts $csvGames "16,Scythe X,1,doom,1,freedoom2.wad,maps/scythex.zip"
